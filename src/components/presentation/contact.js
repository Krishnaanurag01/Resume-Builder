...
function Contact(props) {
   ...
   const [contact,setContact]= useState(props.contact); // storing the redux contact in it.
  
   useEffect(()=>{ // agar koi direct edhar ko aaye then redirect
  ...
  const onchange=(event)=>{
        ...
        setContact({...contact,[key]:val}) // change the value of usestate contact
    }
    //on submit change in redux store
          ...
          <div className="container med contact">
            <div className="section funnel-section">
                ...
                <div className="preview-card">
                    <ResumePreview contactSection={contact} educationSection={null} skinCd={props.document.skincd}></ResumePreview>
                </div>
